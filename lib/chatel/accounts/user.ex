defmodule Chatel.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Chatel.Repo)
  ...
  """
  def username_changeset(user, attrs, _ \\ []) do
    user
    |> cast(attrs, [:username])
    |> case do
  ...
  """
  def valid_password?(%Chatel.Accounts.User{hashed_password: hashed_password}, password)
